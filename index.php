...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php" title="HOME"><i class="ion-paper-airplane"></i> world <span>travel</span></a>
    </div> <!-- /.navbar-header -->
...
<div id="header">
  <div class="flexslider">
    <ul class="slides">
      <li class="slider-item" style="background-image: url('assets/images/item-1.png'); margin-top: 200px;">
        <div class="intro container">
          <div class="inner-intro">
            ...
            <a href="countries.php" class="btn custom-btn">
              Find your interest
            </a>
          </div>
        </div>
